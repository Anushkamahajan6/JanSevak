    ...
    <div className="flex-1 flex flex-col min-h-screen" style={{ background: "#0f1117", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="p-6">
        ...
        <div className="panel">
          {loading ? (
            [1,2,3].map(i => (
              <div key={i} className="vol-row flex justify-between items-center py-4 px-5">
            ...
            <div key={vol._id} className="vol-row flex justify-between items-center py-4 px-5 gap-4">

              {/* LEFT */}
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold text-indigo-300 shrink-0"
                ...
                <div className="min-w-0">
                  ...
                  <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.35)", marginTop: "2px" }}>
                    {vol.type === 'NGO_Affiliated' ? `Affiliated with ${vol.ngoName}` : 'Independent Volunteer'}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 shrink-0">
                {/* Points */}
                {vol.points > 0 && (
                  <div className="flex items-center gap-1" style={{ fontSize: "12px", color: "rgba(255,255,255,0.4)" }}>
