...
export default function SettingsPage() {
  return (
    <div className="flex-1 flex flex-col min-h-screen" style={{ background: "#0f1117", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="topbar px-4 sm:px-6 py-4">
        <div className="flex items-center gap-2">
          <Settings size={16} className="text-indigo-400" />
          <h1 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "17px", fontWeight: 600, color: "rgba(255,255,255,0.9)" }}>Admin Settings</h1>
        </div>
        ...
        <div className="panel sm:col-span-2">
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.35)", marginTop: "3px" }}>Get notified when a new issue is reported</p>
            </div>
            <button className="toggle-btn flex-shrink-0">Enabled</button>
          </div>
        </div>
      </div>
    </div>
